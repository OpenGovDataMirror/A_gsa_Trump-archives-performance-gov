...
var codeBlock2 =   '<h3>Cybersecurity - Manage Asset Security <em>(Updated December 2020)</em></h3>' + '<p>The dashboard below tracks FY2020 Q3 - FY2020 Q4 change for four asset security metrics for 23 federal agencies. Measuring progress in asset security area helps the Federal Government protect federal networks, software, and devices from unauthorized activity.</p>'  + '<a class="usa-button usa-button-secondary " href="/CAP/it-mod/">View the CAP Goal</a>' + ' <a class="usa-button usa-button-secondary " href="/CAP/KPI/Cybersecurity_KPI Data_FY20Q4_11_27_20.xlsx">Download Data</a>' +
...
var codeBlock4 =   '<h3>Cybersecurity - Protect Networks and Data <em>(Updated December 2020)</em></h3>' + '<p>The dashboard below tracks FY2020 Q3 - FY2020 Q4 change for three data protection metrics for 23 federal agencies. Measuring progress in this area helps the Federal Government improve data encryption and protect federal data from unauthorized intrusion and exfultration.</p>'  + '<a class="usa-button usa-button-secondary " href="/CAP/it-mod/">View the CAP Goal</a>' + ' <a class="usa-button usa-button-secondary " href="/CAP/KPI/Cybersecurity_KPI Data_FY20Q4_11_27_20.xlsx">Download Data</a>' +
...
var codeBlock5 =   '<h3>Cloud Email Adoption <em>(Updated December 2020)</em></h3>' + '<p>The dashboard below shows percentage change of agency email inboxes serviced by cloud-based solutions from September 2020 - December 2020.</p>'  + '<a class="usa-button usa-button-secondary " href="/CAP/it-mod/">View the CAP Goal</a>' + ' <a class="usa-button usa-button-secondary " href="/CAP/KPI/Cloud-Emai-Adoption_KPI-Data_FY20Q4.xlsx">Download Data</a>' +
...
var codeBlock6 =   '<h3>Government-wide View <em>(Updated June 2019)</em></h3>' + '<p></p>' + '<a class="usa-button usa-button-secondary " href="/CAP/category-management/">View the CAP Goal</a>' + '<iframe src="https://d2d.gsa.gov/tableau-report-for-embed/8527" id="no-frame-border-1" frameborder="0" style="height:1130px;width:1050px;"></iframe>';
...
var codeBlock7 =   '<h3>Category View <em>(Updated June 2019)</em></h3>' + '<p></p>' + '<a class="usa-button usa-button-secondary " href="/CAP/category-management/">View the CAP Goal</a>' + '<iframe src="https://d2d.gsa.gov/tableau-report-for-embed/8529" id="no-frame-border-1" frameborder="0" style="height:1130px;width:1050px;"></iframe>';

function myFunction8() {
  document.getElementById("wrapper").innerHTML = codeBlock8
}

var codeBlock8 =   '<h3>Department View <em>(Updated June 2019)</em></h3>' + '<p></p>'  + '<a class="usa-button usa-button-secondary " href="/CAP/category-management/">View the CAP Goal</a>' + '<iframe src="https://d2d.gsa.gov/tableau-report-for-embed/8530" id="no-frame-border-1" frameborder="0" style="height:1130px;width:1050px;"></iframe>';

function myFunction9() {
  document.getElementById("wrapper").innerHTML = codeBlock9
}

var codeBlock9 =   '<h3>Agency Progress in Current Fiscal Year <em>(Updated June 2019)</em></h3>' + '<p>The dashboard below compares 2017 and 2018 data from 23 federal agecies towards Category Management targets.</p>'  + '<a class="usa-button usa-button-secondary " href="/CAP/category-management/">View the CAP Goal</a>' + '<iframe src="https://d2d.gsa.gov/tableau-report-for-embed/8531" id="no-frame-border-1" frameborder="0" style="height:1130px;width:1050px;"></iframe>';

function myFunction10() {
  document.getElementById("wrapper").innerHTML = codeBlock10
}

var codeBlock10 =   '<h3>Overview and Definitions <em>(Updated June 2019)</em></h3>' + '<p></p>' + '<a class="usa-button usa-button-secondary " href="/CAP/category-management/">View the CAP Goal</a>' + '<iframe src="https://d2d.gsa.gov/tableau-report-for-embed/8528" id="no-frame-border-1" frameborder="0" style="height:1130px;width:1050px;"></iframe>';

function myFunction11() {
  document.getElementById("wrapper").innerHTML = codeBlock11
}

var codeBlock11 =   '<h3>Customer Satisfaction Scores <em>(Updated June 2020)</em></h3>' + '<p>The dashboard below compares 2019 and 2020 customer satisfaction data from 24 federal agencies in four targeted mission support areas.</p>'  + '<a class="usa-button usa-button-secondary " href="/CAP/sharing-quality-services/">View the CAP Goal</a>' + ' <a class="usa-button usa-button-secondary " href="/CAP/KPI/Customer-Satisfaction-Survey-KPI-data-june-2020.xlsx">Download Data</a>' +
...
var codeBlock12 =   '<h3>Cash Loss to the Government - FY 18-19 <em>(Updated September 2020)</em></h3>' + '<p>The dashboard below shows 2018 - 2019 change in cash loss to the government by program across 23 federal agecies.</p>' + '<a class="usa-button usa-button-secondary " href="/CAP/getting-payments-right/">View the CAP Goal</a>' + ' <a class="usa-button usa-button-secondary " href="/CAP/KPI/Cash Loss to the Government_KPI Data_FY20Q3.xlsx">Download Data</a>'  +
...
var codeBlock13 =   '<h3>Cash Loss to the Government - Program Scorecards <em>(Updated December 2020)</em></h3>' + '<p>The government can achieve the greatest return on investment for the taxpayer by ensuring that improper payments are eliminated in the highest-risk programs, otherwise known as high-priority programs. Details about these programs can be found in the dashboard below as well as steps to improve their efficiency by focusing on reducing incorrect payment that result in monetary loss.</p>'  + '<a class="usa-button usa-button-secondary " href="/CAP/getting-payments-right/">View the CAP Goal</a>' + ' <a class="usa-button usa-button-secondary " href="/CAP/KPI/Cash-Loss-to-the Government_KPI-Data_FY20Q4.xlsx">Download Data</a>' + '<iframe src="https://d2d.gsa.gov/tableau-report-for-embed/8537" id="no-frame-border-1" frameborder="0" style="height:1130px;width:1050px;"></iframe>';
